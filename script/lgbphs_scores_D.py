...
def main():
  ...
  zfiles = db.Zobjects(directory=config.features_dir, extension=config.features_ext, protocol=config.protocol, groups=args.group)
  ...
  import lgbphs
  lgbphs.lgbphs_ztnorm_D(tnorm_models_ids, config.tnorm_models_dir, zfiles, db, 
