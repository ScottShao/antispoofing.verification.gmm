...
def main():
  ...
  job_scores_ZT = submit(jm, cmd_scores_ZT, dependencies=[job_scores_Am.id(), job_scores_Bm.id(),job_scores_Cm.id(), job_scores_Dm.id()], queue='q1d', mem_free='3G', hostname='!beaufix&!cicatrix')
