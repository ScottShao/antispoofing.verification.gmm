...
def main():
  ...
  job_jfabase = submit(jm, cmd_jfabase, dependencies=[job_gmmstats.id()], array=None, queue='q1d')
  ...
  if config.zt_norm:
    for group in ['dev','eval']:
      ...
      job_tnorm_int = submit(jm, cmd_tnorm, dependencies=[job_jfabase.id()], array=(1,n_array_jobs,1))
  ...
  for group in ['dev','eval']:
    ...
    job_models_int = submit(jm, cmd_models, dependencies=[job_jfabase.id()], array=(1,n_array_jobs,1))
  ...
  for group in ['dev','eval']:
    ...
    job_scores_int = submit(jm, cmd_scores_A, dependencies=deps, array=(1,n_array_jobs,1), queue='q1d', mem_free='3G', hostname='!beaufix&!cicatrix')
  ...
  if config.zt_norm:
    for group in ['dev','eval']:
      ...
      job_scores_int = submit(jm, cmd_scores_B, dependencies=deps, array=(1,n_array_jobs,1), queue='q1d', mem_free='3G', hostname='!beaufix&!cicatrix')
  ...
  if config.zt_norm:
    for group in ['dev','eval']:
      ...
      job_scores_int = submit(jm, cmd_scores_C, dependencies=deps, array=(1,n_array_jobs,1), queue='q1d', mem_free='3G', hostname='!beaufix&!cicatrix')
  ...
  if config.zt_norm:
    for group in ['eval']:
      ...
      job_scores_int = submit(jm, cmd_scores_D, dependencies=deps, array=(1,n_array_jobs,1), queue='q1d', mem_free='3G', hostname='!beaufix&!cicatrix')
  ...
  job_scores_ZT = submit(jm, cmd_scores_ZT, dependencies=[job_scores_Dm.id()], queue='q1d', mem_free='3G', hostname='!beaufix&!cicatrix')
  ...
  job_cat = submit(jm, cmd_cat, dependencies=[job_scores_ZT.id()], array=None)
